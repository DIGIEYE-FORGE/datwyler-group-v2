          ...
          <div className="w-[100] h-[80%] flex flex-col mt-[3rem] gap-[2rem] py-[1rem]">
            <div className="flex gap-[2rem] w-[100%]">
              <div className="w-[50%]">
                ...
                <br />
                <input type="text" className="h-[3rem] w-[100%]" value={
                  data.firstName
                } 
                onChange={(e) => {
                  setData({
            ...
            <div className="flex w-[100%] gap-[1rem]">
              ...
              <Button    className="h-[3rem]  w-[6rem] bg-transparent text-[#0091AE]"
                  style={{
              ...
              <Button className="h-[3rem]  w-[6rem] bg-[#0091AE]/90" onClick={()=>{
                data?.attributes == null && setData({
                  ...data,
