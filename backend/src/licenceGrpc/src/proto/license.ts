...
import type {
  LicenseServiceClient as _licensePackage_LicenseServiceClient,
  LicenseServiceDefinition as _licensePackage_LicenseServiceDefinition,
} from './licensePackage/LicenseService';
...
export interface ProtoGrpcType {
  licensePackage: {
    ...
    LicenseService: SubtypeConstructor<
      typeof grpc.Client,
      _licensePackage_LicenseServiceClient
    > & { service: _licensePackage_LicenseServiceDefinition };
